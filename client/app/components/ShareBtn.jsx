...
function ShareBtn({url}) {
  ...
  return (
    <div className="relative inline-block">
      <button onClick={handleShareClick} className="px-1 py-2  text-white rounded  ">
      ...
      {showTooltip && (
        <div className="absolute z-10 -left-20 -ml-3 top-1 transform -translate-y-1/2 bg-white text-black text-xs rounded py-1  px-4 shadow-lg">
          url copied
        </div>
      )}
    </div>
